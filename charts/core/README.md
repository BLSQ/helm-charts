...
![Version: 0.33.0](https://img.shields.io/badge/Version-0.33.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.16.0](https://img.shields.io/badge/AppVersion-1.16.0-informational?style=flat-square)
...
| tolerations | list | `[{"effect":"NoSchedule","key":"main","operator":"Equal","value":"true"}]` | Tolerations that are added to pods to allow them to schedule onto nodes with certain taints. |
